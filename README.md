...
In this project, you will demonstrate proficiency by writing unit tests forinst an existing React application. Your tests should verify the behavior listed in the _Minimum Viable Product_ section.
